...
PlanExecutorNode::PlanExecutorNode(const string &domain_directory,
                                   map<string, actasp::Action *> action_map,
...
//   }
  ...
  //StaticFacts::retrieveStaticFacts(reasoner, domainDirectory);
  {
    ...
    auto replanner = new ReplanningPlanExecutor(reasoner, reasoner, action_map);
