...
bool service_cb(bwi_moveit_utils::MicoMoveitWaypoint::Request &req, bwi_moveit_utils::MicoMoveitWaypoint::Response &res){
...
int main(int argc, char **argv){
    ros::init(argc, argv, "mico_moveit_waypoint_service");
    ros::NodeHandle nh;
    ...
    ros::ServiceServer srv = nh.advertiseService("mico_waypoint_service", service_cb);
