# -*- coding: utf-8 -*-
#
# stop_base documentation build configuration file
#
...
htmlhelp_basename = 'stop_base_pydoc'
...
latex_documents = [
  ('index', 'stop_base.tex',
   u'ROS Python stop_base support.',
...
texinfo_documents = [
  ('index', 'stop_base',
   u'stop_base Documentation', u'Jack O\'Quin',
   'stop_base', 'stop_base.', 'Miscellaneous'),
]
